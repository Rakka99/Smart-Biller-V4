...
data class Customer(val id: String, val customerNo: String, val name: String?, val meterNo: String?, val address: String?, val ulp: ULP?, val latitude: Double?, val longitude: Double?)
data class ULP(val name: String?)
data class Billing(val id: String, val period: String, val category: String, val status: String, val total: Double, val dueDate: String, val customer: Customer)
